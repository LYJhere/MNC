...
dataset_name = 'SIRI-WHU'  # cifar10/ cifar20 / ImageNet-dogs / ImageNet-10/train / tiny-imagenet-200/train / RSOD /
...
for epoch in [1000]:
    checkpoint = f'ckpt/2024_01_10_15_50_24-siriwhu_r18_propos/save_models/byol-{epoch}'
    msg = byol.load_state_dict(torch.load('/home/derek/disk2/derek/lyj/propos_groco/ckpt/2024_01_10_17_26_51-siriwhu_r18_propos/save_models/byol-1000', map_location='cpu'), strict=False)
    print(msg)
