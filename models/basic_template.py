...
class TrainTask(object):
    ...
    def build_default_options():
        ...
        parser.add_argument('--test_freq', type=int, default=200, help='test frequency')
        ...
        parser.add_argument('--resume_epoch', type=int, default=200, help='number of training epochs')
        ...
        parser.add_argument('--dataset', type=str, default='RSOD', help='dataset')
        parser.add_argument('--data_folder', type=str, default='/home/derek/datasets',
        ...
        parser.add_argument('--model_name', type=str, help='the type of method', default='contrastive_cluster')
    ...
    def fit(self):
        ...
        while True:
            ...
            if (self.cur_epoch % opt.test_freq == 0) or (self.cur_epoch % opt.save_freq == 0):
