...
class BYOL(TrainTask):
    ...
    def train(self, inputs, indices, n_iter):
        ...
        with open(f"{self.logger.images_save_dir}/loss_logger.txt", "a") as f:
            f.write(
                f"Epoch[{self.cur_epoch}] contrastive_loss={contrastive_loss},cluster_loss_batch={cluster_loss_batch}\n")
